...
$string = "<div class=\"content-wrapper\">
    <section class=\"content\">
        ...
        <?php echo anchor(site_url('".$c_url."/create'), '<i class=\"fa fa-wpforms\" aria-hidden=\"true\"></i> Tambah Data', 'class=\"btn btn-primary btn-sm\"'); ?>";
...
$string .= "\n\t\t\t<td style=\"text-align:center\" width=\"200px\">"
        . "\n\t\t\t\t"
        . "<a href=\"<?= site_url('".$c_url."/read/'.$".$c_url."->".$pk.") ?>\" class=\"btn btn-info btn-sm\" title=\"View Data\"><i class=\"fa fa-eye\" aria-hidden=\"true\"></i></a> "
        . "<a href=\"<?= site_url('".$c_url."/update/'.$".$c_url."->".$pk.") ?>\" class=\"btn btn-success btn-sm\" title=\"Update Data\"><i class=\"fa fa-pencil-square-o\" aria-hidden=\"true\"></i></a> "
        . "<a href=\"<?= site_url('".$c_url."/delete/'.$".$c_url."->".$pk.") ?>\" title=\"Delete Data\" class=\"btn btn-danger btn-sm\" onclick=\"return confirm('Are you sure ?')\"><i class=\"fa fa-trash-o\"></i></a>"
        . "\n\t\t\t</td>";
