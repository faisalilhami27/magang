...
<div class="login-box">
    ...
    <div class="login-box-body" style="border-radius: 7px">
        ...
        <div class="row">
            <button style="position: relative; left: 15px" type="submit" class="btn btn-primary"><i
                        class="fa fa-sign-in" aria-hidden="true"></i> Login
            </button>
            <span style="float: right; position: relative; left: -15px"><?php echo anchor('auth/forgot_password', '<i class="fa fa-eye-slash" aria-hidden="true"></i> Lupa Password', array('class' => 'btn btn-danger')); ?></span>
        </div>
        </form>
    </div>
    <!-- /.login-box-body -->
