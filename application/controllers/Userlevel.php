...
class Userlevel extends CI_Controller
{
    ...
    function get_data_level()
    {
        ...
        foreach ($list as $field) :
            ...
            $row[] = '<center>
                        <a href="' . site_url('userlevel/akses/' . $field->id_user_level) . '" title="Ubah Hak Akses" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                        <a href="' . site_url('userlevel/update/' . $field->id_user_level) . '" title="Update Data" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o"></i></a>
                        <a href="' . site_url('userlevel/delete/' . $field->id_user_level) . '" title="Delete Data" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure ?\')"><i class="fa fa-trash-o"></i></a>
                     </center>';
            $data[] = $row;
        endforeach;
        $output = array(
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'nama_level' => htmlspecialchars($this->input->post('nama_level', TRUE)),
            );
